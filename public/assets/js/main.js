...
/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (mobileTest = !0), $(document).on("click", ".navbar-collapse.in", function(e) {
  ...
  function() {
    $(function() {
      ...
      return e.preventDefault(), $("#videoBackground").YTPToggleVolume(), $(this).toggleClass("fa-volume-off fa-volume-up"), !1
    })
  }(),
  function() {
    Grid.init()
...
ischrome && (ssc_addEvent("mousedown", ssc_mousedown), ssc_addEvent("mousewheel", ssc_wheel), ssc_addEvent("load", ssc_init)), $("#subscription-form_disabled").submit(function(e) {
	/* RYL - The #subscription-form has been changed to #subscription-form_disabled to disable the behavior */
    e.preventDefault();
