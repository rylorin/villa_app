...
class PageExtension extends \Twig_Extension implements \Twig_Extension_InitRuntimeInterface
{
     ...
     */
    public function __construct(CmsManagerSelectorInterface $cmsManagerSelector, SiteSelectorInterface $siteSelector, RouterInterface $router, BlockHelper $blockHelper, HttpKernelExtension $httpKernelExtension, $hideDisabledBlocks = true /* RYL false */)
    {
...
/*        $this->hideDisabledBlocks = $hideDisabledBlocks; */
    ...
    {
//        echo $block->getName(), $block->getEnabled(), $this->hideDisabledBlocks;
