...
use Ryl\CharityBundle\Entity\Sponsor;
use Ryl\CharityBundle\Form\SponsorType;
...
class SponsorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RylCharityBundle:Sponsor')->findAll();

        return $this->render('RylCharityBundle:Sponsor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RylCharityBundle:Sponsor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RylCharityBundle:Sponsor')->find($id);
        ...
        return $this->render('RylCharityBundle:Sponsor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RylCharityBundle:Sponsor:edit.html.twig', array(
            'entity'      => $entity,
